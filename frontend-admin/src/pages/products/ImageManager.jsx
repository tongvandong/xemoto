...
const SHOW_PRODUCT_IMAGE_UPLOAD_INPUT = false; // Đổi thành false để ẩn phần upload ảnh từ máy tính trong quản lý ảnh sản phẩm.
const SHOW_PRODUCT_IMAGE_URL_INPUT = true; // Đổi thành false để ẩn phần nhập URL ảnh trong quản lý ảnh sản phẩm.
