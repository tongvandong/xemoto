...
const BRAND_LIST_CONTROLS = {
  ...
  showLogoFilter: true, // Đổi thành false để ẩn bộ lọc logo hãng xe.
  showSort: true, // Đổi thành false để ẩn phần sắp xếp hãng xe.
  showReload: true, // Đổi thành false để ẩn nút tải lại hãng xe.
};
